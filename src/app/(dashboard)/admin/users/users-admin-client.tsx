                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b bg-muted/50">
                                    ...
                                    <th className="px-4 py-3 text-left text-sm font-medium text-muted-foreground">Instrument</th>
                                    <th className="px-4 py-3 text-left text-sm font-medium text-muted-foreground">Major</th>
                                ...
                                {users.map((user) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 text-sm">
                                            {user.instrument || <span className="text-muted-foreground">—</span>}
                                        </td>
                                        <td className="px-4 py-3 text-sm">
                                            {user.major || <span className="text-muted-foreground">—</span>}
                                        </td>
                                        <td className="px-4 py-3 text-sm">
                                            {user.graduation_year || <span className="text-muted-foreground">—</span>}
                                        </td>
                                        <td className="px-4 py-3">
                                            <Badge
