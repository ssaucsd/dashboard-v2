...
import { Calendar, MapPin, ArrowRight01Icon, Clock, Book } from "@hugeicons/core-free-icons";
                        ...
                        {events && events.length > 0 ? (
                            ...
                            <div className="w-full flex flex-col items-center justify-center py-12 text-center text-muted-foreground bg-muted/10 rounded-lg border-2 border-dashed border-muted/20">
                                <div className="bg-background p-3 rounded-full shadow-sm mb-4">
                                    <HugeiconsIcon icon={Calendar} width={32} height={32} className="text-muted-foreground/50" />
                                </div>
                                <h3 className="text-lg font-medium font-serif text-foreground">No Upcoming Events</h3>
                ...
                <Card className="col-span-1 w-full">
                    ...
                    <CardContent className="flex flex-col gap-4">
                        {resources && resources.length > 0 ? (
                            ...
                            <div className="w-full flex flex-col items-center justify-center py-12 text-center text-muted-foreground bg-muted/10 rounded-lg border-2 border-dashed border-muted/20">
                                <div className="bg-background p-3 rounded-full shadow-sm mb-4">
                                    <HugeiconsIcon icon={Book} width={32} height={32} className="text-muted-foreground/50" />
                                </div>
                                <h3 className="text-lg font-medium font-serif text-foreground">No Pinned Resources</h3>
                                <p className="text-sm text-muted-foreground max-w-[250px]">
